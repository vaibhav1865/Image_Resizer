...
void solve(int ***rgb, int H, int W, int C, int H_, int W_, int C_) 
{
          ...
          int ***temp;
            ...
            // {
            //     for(int row = 0 ; row <= W_ ; row++)
            //     {
            //         for(int k = 0;k < C;k++)
            //         {
            //             temp[row][col][k] = rgb[H-1-col][row][k];
            //         }
            //     }
            // }
           ...
           { 
            ...
            // for (int i = 0; i < (H - v); i++) 
            // {
            //     grad[i] = new double[W_];
            //     cost[i] = new double[W_];
            //     bt[i] = new double[W_];
            // }
    
                
            // gradient(grad,rgb, H -v, W_, C);
            // costcalv(cost,grad,bt,H -v,W_,C);
            ...
            // }
            // shiftrgbv(rgb,H - v,W_,C,i_idx,j_idx);
            ...
            //       i_idx = bt[i_idx][i];
            //       shiftrgbv(rgb,H - v,W_,C,i_idx,i-1);   
